...
```{r}
Full_avg <- cbind(Full_grid[,1], apply(Full_grid[,2:327], 1, mean, na.rm = TRUE))
...
```{r}
Full_med <- cbind(Full_grid[,1], "Median" = apply(Full_grid[,2:327], 1, median, na.rm = TRUE))
write.csv(Full_avg, file = "C:\\Users\\aboser\\Documents\\GitHub\\PM_prediction\\Data\\Final_DFs\\Model_maps\\2S_med_redGWR.csv", row.names = FALSE)
```
